...
# RD-IDRE-2020/08/17-ADDED-SILENT-PACKAGE-INSTALLATION
#myver <- substr((paste0(R.version$major,".",R.version$minor)), 1, 5)
#mydir <- paste0('~/R/x86_64-pc-linux-gnu-library-RH7/',myver)
mydir=Sys.getenv("R_LIBS_USER")
.libPaths(new=mydir)
dir.create(mydir, showWarnings = FALSE, recursive = TRUE)
install.packages('SuppDists', repos="http://cran.r-project.org", lib=mydir)
